pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.204.182.189:9090/manager/html'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/SARADEEPIKAMAMIDALA/Fullstack_AWS_deploy.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.204.182.189:9090/springapp1"
            echo "✅ Frontend deployed: http://54.204.182.189:9090/frontapp1"
        }
        failure {
