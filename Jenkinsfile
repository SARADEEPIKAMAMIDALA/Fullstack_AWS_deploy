pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://3.210.216.40:9090/manager/html'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://3.210.216.40:9090/springapp1"
            echo "✅ Frontend deployed: http://3.210.216.40:9090/frontapp1"
        }
        failure {
